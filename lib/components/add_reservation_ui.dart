...
import 'package:bobo_ui/ui/card_reservation.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
        children: <Widget>[
          ...
          RaisedButton(
            onPressed: _table == null ? null : _reservationDateTime == null ? null :
            () async {
                ...
                builder: (context){
                  return AlertDialog(
                    ...
                    content: SingleChildScrollView(
                      child: ListBody(
                        children: <Widget>[
                          Row(children: <Widget>[Text("Table cost :"), SizedBox(width: 10,),Text('Ksh. ${_reservationModal.tableReservationCost.toString()}'),],),
                                        ...
                                        showModalBottomSheet(
                                          ...
                                          builder: (context){
                                            return ChangeNotifierProvider.value(
                                              ...
                                              child: MpesaTopupModalReservation(reservationModal: _reservationModal),
                                            );
                                          }
                                        );
                                      },
